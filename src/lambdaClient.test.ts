  ...
  return {
    ...
    state: {
      ...
      identityCenter: {
        ...
        groupMemberships: [],
        permissionSets: [{ permissionSetArn: "arn:ps:1", name: "Admin", description: "Full access", inlinePolicy: null, awsManagedPolicies: ["arn:aws:iam::aws:policy/AdministratorAccess"], customerManagedPolicies: [] }],
        accountAssignments: [
