...
const configExpressionPattern =
  /const awsConfig: AwsConfig = ([\s\S]*?)\s*satisfies AwsConfig;\s*export default awsConfig;/;
...
const awsConfig: AwsConfig = ${JSON.stringify(props.config, null, 2)} satisfies AwsConfig;
