...
type IdentityCenterOperationKind =
  | "createIdcUser"
  | "updateIdcUser"
  | "deleteIdcUser"
  | "createIdcGroup"
  ...
  | "putIdcPermissionSetPermissionsBoundary"
  | "deleteIdcPermissionSetPermissionsBoundary"
  | "grantIdcAccountAssignment"
  | "revokeIdcAccountAssignment"
  | "setIdcAccessControlAttributes";

type IdentityCenterOperation = Extract<Operation, { kind: IdentityCenterOperationKind }>;

type ExecuteIdentityCenterOperationProps = {
  state: WorkingState;
  ...
  operation: IdentityCenterOperation;
};

export async function executeIdentityCenterOperation(
  props: ExecuteIdentityCenterOperationProps,
  ...
  assertUnreachable(props.operation, "Unsupported identity center operation kind.");
}
